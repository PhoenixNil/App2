...
public class MainWindowViewModel : ViewModelBase
{
	...
	private bool _isBypassChinaMode = true; // true = 绕过大陆(使用ACL), false = 全局路由(不用ACL)
	...
	public bool ValidateAndUpdateLocalPort(double value, out string? errorMessage)
	{
		...
		{
			errorMessage = $"端口号必须在 {MinimumLocalPort} 到 {MaximumLocalPort} 之间。";
			return false;
		}
